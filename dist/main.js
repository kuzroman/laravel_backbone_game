...
var vent = exports.vent = _.extend({
...
exports.dataWorks = exports.WorksPageView = undefined;

var _helper = __webpack_require__(1);

var WorksPageView = exports.WorksPageView = Backbone.View.extend({
    className: 'page works',
    initialize: function initialize() {
        this.render();
        new WorksView({ pageV: this });

        this.listenTo(_helper.vent, 'removePage', this.remove);
    },
    ...
    remove: function remove() {
        ...
        _helper.vent.off('removePage');
        this.$el.addClass('rotate');
        setTimeout(function () {
            Backbone.View.prototype.remove.call(_this);
            _helper.vent.trigger('removeWork');
        }, _helper.params.speedChangePage);
    }
});
...
var WorksView = Backbone.View.extend({
    ...
    initialize: function initialize(options) {
        ...
        this.listenTo(_helper.vent, 'removeWork', this.remove);
    },
    render: function render() {
...
var WorkView = Backbone.View.extend({
    ...
    template: _helper.hp.tmpl('tmplWork'),
    initialize: function initialize() {
        this.render();
        this.listenTo(_helper.vent, 'removeWork', this.remove);
    },
...
exports.letters = exports.TypingV = undefined;
...
var TypingV = exports.TypingV = Backbone.View.extend({
    id: 'typingCenter',
    ...
    initialize: function initialize(options) {
        ...
        this.render();
        this.resize();
        this.listenTo(_helper.vent.game, 'textLoaded', this.updateLettersPosition);
        this.listenTo(_helper.vent, 'pageLoaded', this.updateLettersPosition);
    ...
    showLetter: function showLetter() {
        ...
        this.interval = setInterval(function () {
            ...
            if (letter.model.get('isGoal')) {
                _helper.vent.trigger('letterShowed', { // pass to canvass
                    x: letter.model.get('x2'),
                    y: letter.model.get('y2')
                });
            }
            if (len <= ++i) {
                _helper.vent.game.trigger('textLoaded');
...
var letters = exports.letters = new Letters(arrLetter); // collection
...
var Router = Backbone.Router.extend({
    ...
    game: function game() {
        _helper.vent.trigger('removePage');
        new _game.GamePageView();
    },
    contact: function contact() {
        _helper.vent.trigger('removePage');
        new _contact.ContactPageView();
    },
    skills: function skills() {
        _helper.vent.trigger('removePage');
        new _skills.SkillsPageView();
    },
    work: function work() {
        _helper.vent.trigger('removePage');
        new _work.WorksPageView();
    },
    workDesc: function workDesc(pageName) {
        _helper.vent.trigger('removePage');
        new _desc.DescPageV({ pageName: pageName });
    }
});

var router = new Router();
Backbone.history.start();
new _topNav.NavigationView();

new _audio.Audio(); // ! зависит от положинея. ставить после роутов!
...
var Audio = exports.Audio = Backbone.View.extend({
    initialize: function initialize() {
        _helper.vent.audio.on('play', this.createSound); // ��������! ������� �� ���������. ������ ���� ���� ��� sound
...
var FactorySounds = Backbone.View.extend({
    ...
    initialize: function initialize(nameSound) {
        ...
        _helper.vent.audio.on('killGameAudio', this.removeGameAudio, this);
        _helper.vent.audio.on('killBgAudio', this.removeBgAudio, this);
        //vent.on('removePage', this.remove, this); // ���������� �� ��������!
    },
    play: function play() {
    ...
    removeGameAudio: function removeGameAudio() {
        if (this.group == 'game') {
            _helper.vent.audio.off('killGameAudio');
            this.remove();
        }
    },
    removeBgAudio: function removeBgAudio() {
        if (this.group == 'bg') {
            _helper.vent.audio.off('killBgAudio');
            this.remove();
        }
    },
    remove: function remove() {
...
var SoundCheck = Backbone.View.extend({
    ...
    initialize: function initialize() {
        this.sound = false;
        this.render();
        _helper.vent.audio.on('showBackground', this.show, this);
        _helper.vent.audio.on('hideBackground', this.hide, this);
        //vent.on('removePage', this.remove, this);
    },
    render: function render() {
        var _this = this;
    ...
    play: function play() {
        ...
        _helper.vent.audio.trigger('play', 'sound1');
        this.sound = true;
    },
    stop: function stop() {
        this.$el.removeClass('play');
        _helper.vent.audio.trigger('killBgAudio');
        this.sound = false;
    },
    show: function show() {
...
exports.NavigationView = undefined;

var _helper = __webpack_require__(1);

var NavigationView = exports.NavigationView = Backbone.View.extend({
    initialize: function initialize() {
...
var NavMenuView = Backbone.View.extend({
    ...
    template: _helper.hp.tmpl('tmplMenu'),
    events: {
        'click a': 'clickLinc'
    },
    initialize: function initialize() {
...
exports.SkillsPageView = undefined;

var _helper = __webpack_require__(1);

var SkillsPageView = exports.SkillsPageView = Backbone.View.extend({
    ...
    remove: function remove() {
        ...
        setTimeout(function () {
            Backbone.View.prototype.remove.call(_this);
            _helper.vent.trigger('removeSkill');
        }, _helper.params.speedChangePage);
    }
});
...
var ResumeView = Backbone.View.extend({
    className: 'content',
    template: _helper.hp.tmpl('tmplResume'),
    initialize: function initialize(options) {
        this.parentV = options.pageV;
        this.render();
        //vent.on('removeSkill', this.remove, this);
        this.listenTo(_helper.vent, 'removeSkill', this.remove);
    },
    render: function render() {
...
var SkillView = Backbone.View.extend({
    tagName: 'a',
    className: 'works-work',
    template: _helper.hp.tmpl('tmplSkill'),
    initialize: function initialize() {
        this.render();
        _helper.vent.on('removeSkill', this.remove, this);
    },
    render: function render() {
        this.$el.html(this.template(this.model.toJSON()));
    }
...
exports.GamePageView = undefined;
...
var _shooter = __webpack_require__(14);

var _canvasPartialsFall = __webpack_require__(15);

var _boardResult = __webpack_require__(16);

var _boardLeader = __webpack_require__(17);
...
var Game = Backbone.Model.extend({
    ...
    initialize: function initialize() {
        this.listenTo(_helper.vent.game, 'textLoaded', function () {
            this.set('textLoaded', true);
        }, this);
        this.listenTo(_helper.vent.game, 'changeDestroyed', function () {
            this.counter('destroyed');
        }, this);
        this.listenTo(_helper.vent.game, 'changeShoots', function () {
            this.counter('shoots');
        }, this);
        this.listenTo(_helper.vent.game, 'changeTimeSpend', function () {
            this.counter('timeSpend');
        }, this);
        this.listenTo(_helper.vent.game, 'changeBulletsReachedGoal', function () {
            this.counter('bulletsReachedGoal');
        }, this);
        this.listenTo(_helper.vent.game, 'startGame', function () {
    ...
    isGameFinished: function isGameFinished() {
        ...
        _helper.vent.game.trigger('stopGame');
        return true;
    },
...
var GamePageView = exports.GamePageView = Backbone.View.extend({
    className: 'page game',
    initialize: function initialize() {
        this.modules = {};
        this.show();
        ...
        _helper.vent.game.on('stopGame', this.stopGame, this);
        _helper.vent.game.on('showBtn', function () {
    ...
    render: function render() {
        ...
        $('body').append(this.$el);
        this.modules.btn = new _btn.Btn(this.options);
    },
    loadModules: function loadModules() {
        this.modules.typingV = new _typing.TypingV(this.options);
        this.modules.canvasV = new _canvasPartialsFall.CanvasV(this.options);
        this.modules.shooterV = new _shooter.ShooterV(this.options);
        this.modules.loaderV = new _loader.LoaderV(this.options);
        this.modules.boardResultV = new _boardResult.BoardResultV(this.options);
        this.modules.boardLeaderV = new _boardLeader.BoardLeaderV(this.options);
        this.shooterMouseAreaV = new _shooter.ShooterMouseAreaV(this.options);
    },
    startGame: function startGame(model, gameStarted) {
        ...
        _helper.vent.audio.trigger('hideBackground');
        _helper.vent.audio.trigger('play', 'startGame');
    },
    stopGame: function stopGame() {
        ...
        _helper.vent.audio.trigger('killGameAudio');
        _helper.vent.audio.trigger('showBackground');
    },
    remove: function remove() {
        var _this = this;
        ...
        setTimeout(function () {
            Backbone.View.prototype.remove.call(_this);
            _helper.vent.trigger('removeGame');
        }, _helper.params.speedChangePage);
    },
    updateView: function updateView() {
        this.remove();
...
exports.Btn = exports.BtnModel = undefined;

var _helper = __webpack_require__(1);

var BtnModel = exports.BtnModel = Backbone.Model.extend({
    defaults: {
...
exports.LoaderV = undefined;

var _helper = __webpack_require__(1);

var LoaderV = exports.LoaderV = Backbone.View.extend({
    id: 'scoreBord',
    className: 'scoreBord',
    template: _helper.hp.tmpl('tmplScoreBoard'),
    initialize: function initialize(options) {
        this.parentV = options.pageV;
        this.render();
...
exports.ShooterV = exports.ShooterMouseAreaV = undefined;
 ...
 */
var ShooterMouseAreaV = exports.ShooterMouseAreaV = Backbone.View.extend({
    id: 'shooterMouseArea',
    events: {
    ...
    bulletShot: function bulletShot() {
        ...
        _helper.vent.audio.trigger('play', 'shoot');
        _helper.vent.game.trigger('changeShoots');
...
var ShooterV = exports.ShooterV = Backbone.View.extend({
    id: 'shooter',
    className: 'shooter',
    initialize: function initialize(options) {
        this.parentV = options.pageV;
...
var Canvas = Backbone.View.extend({
    ...
    calcBurstPosition: function calcBurstPosition() {
        ...
        for (var j = 0, b, lenBullets = this.bullets.length; j < lenBullets; j++) {
            b = this.bullets[j];
            b.move();
            b.draw();

            var aims = _typing.letters.models,
                bX1 = b.x - b.radius,
                bX2 = b.x + b.radius;
            ...
            for (var i = 0, len = aims.length; i < len; i++) {
                ...
                if (b.y == y2 || b.y == y2 - 1 || b.y == y2 + 1) {
                    ...
                    bX1 <= aims[i].get('x2') && aims[i].get('x2') <= bX2) {
                        // bullet at right
                        // they on the one axis x - Goal!
                        aims[i].set('killed', true);
                        _helper.vent.game.trigger('changeDestroyed', { x: b.x, y: b.y });

                        if (!b.isReachedGoal) {
                            b.isReachedGoal = true;
                            _helper.vent.game.trigger('changeBulletsReachedGoal');
                            _helper.vent.audio.trigger('play', 'destroyed');
                        }
                    }
                }
            }
...
var CanvasV = exports.CanvasV = Backbone.View.extend({
    ...
    initialize: function initialize(options) {
        ...
        this.listenTo(_helper.vent, 'letterShowed', this.animation);
        this.listenTo(_helper.vent, 'removeGame', this.remove);
    },
    render: function render() {
        engravingText.p = {
...
engravingText.Bit = function () {
    function _class(currentX, currentY) {
...
engravingText.updateBit = function () {
    ...
    for (var j = 0, b; j < bits.length; j++) {
        b = bits[j];
        b.y -= b.g;
        b.g -= 0.1;

        if (_helper.params.bodyH < b.y) bits.splice(j, 1);
        b.draw();
    }
...
exports.BoardResultV = undefined;

var _helper = __webpack_require__(1);

var BoardResultV = exports.BoardResultV = Backbone.View.extend({
    id: 'results',
    className: 'results',
    template: _helper.hp.tmpl('tmplBoardResult'),
    events: {
    ...
    close: function close() {
        this.hide();
        _helper.vent.game.trigger('showBtn');
    },
    openBoardLeader: function openBoardLeader() {
        this.hide();
        _helper.vent.trigger('openBoardLeader');
    },
    show: function show() {
        this.isShowed = true;
        this.setAccuracy();
        ...
        this.scoring();
        this.$el.animate({ left: (_helper.params.bodyW - this.$el.width()) / 2, opacity: 1 }, 300);
    },
    hide: function hide() {
        this.isShowed = false;
    ...
    resize: function resize() {
        ...
        $(window).on('resize', function () {
            ...
            clearTimeout(resizeTimeoutId);
            resizeTimeoutId = setTimeout(function () {
                self.$el.animate({ left: (_helper.params.bodyW - self.$el.width()) / 2, opacity: 1 }, 300);
            }, 200);
        });
    }
});
...
exports.BoardLeaderV = undefined;

var _helper = __webpack_require__(1);

var BoardLeaderV = exports.BoardLeaderV = Backbone.View.extend({
    id: 'leaders',
    className: 'results',
    template: _helper.hp.tmpl('tmplBoardLeader'),
    events: {
        'click .resultsClose': 'close'
    },
    initialize: function initialize(options) {
        ...
        this.render();
        this.resize();
        this.listenTo(_helper.vent, 'openBoardLeader', this.show);
        this.listenTo(_helper.vent, 'hadGotScores', this.hadGotScores);
        this.listenTo(_helper.vent, 'removeGame', this.remove);
    },
    render: function render() {
        this.parentV.$el.append(this.$el.append(this.template));
    ...
    hide: function hide() {
        this.isShowed = false;
        this.$el.animate({ left: _helper.params.bodyW, opacity: 0 }, 300);
    },
    getScore: function getScore() {
        ...
        scores.fetch({
            success: function success() {
                ...
                _helper.vent.trigger('hadGotScores', scores);
            },
...
var LeaderV = Backbone.View.extend({
    tagName: 'li',
    template: _helper.hp.tmpl('tmplLeader'),
    templateCurrentScore: _helper.hp.tmpl('tmplYourScore'),
    events: {
...
exports.DescPageV = undefined;

var _helper = __webpack_require__(1);

var _work = __webpack_require__(4);

var _backPage = __webpack_require__(19);

var DescPageV = exports.DescPageV = Backbone.View.extend({
    className: 'page desc',
    initialize: function initialize(options) {
        options = _.extend({ pageV: this }, options);
        new DescV(options);
        new _backPage.BackPageV(options);

        this.render();
        this.listenTo(_helper.vent, 'pageLoaded', this.scrollUp);
        this.listenTo(_helper.vent, 'removePage', this.remove);
    },
    render: function render() {
        $('body').append(this.el);
    ...
    remove: function remove() {
        ...
        setTimeout(function () {
            Backbone.View.prototype.remove.call(_this);
            _helper.vent.trigger('removeDesc');
        }, _helper.params.speedChangePage);
    },
...
var DescV = Backbone.View.extend({
    className: 'content',
    template: _helper.hp.tmpl('tmplDesc'),
    initialize: function initialize(options) {
        ...
        this.listenTo(_helper.vent, 'removeDesc', this.remove);
    },
    render: function render() {
        var _this2 = this;

        var data = _.find(_work.dataWorks, function (model) {
            return model['href'] == _this2.pageName;
        });
...
exports.BackPageV = undefined;

var _helper = __webpack_require__(1);

var BackPageV = exports.BackPageV = Backbone.View.extend({
    tagName: 'a',
...
exports.ContactPageView = undefined;

var _helper = __webpack_require__(1);

var ContactPageView = exports.ContactPageView = Backbone.View.extend({
    ...
    remove: function remove() {
        ...
        setTimeout(function () {
            Backbone.View.prototype.remove.call(_this);
            _helper.vent.trigger('removeContact');
        }, _helper.params.speedChangePage);
    }
});

var ContactDescView = Backbone.View.extend({
    template: _helper.hp.tmpl('tmplContact'),
    initialize: function initialize(options) {
        this.parentV = options.pageV;
        this.render();
        this.listenTo(_helper.vent, 'removeContact', this.remove);
    },
    render: function render() {
        this.parentV.$el.append(this.el);
